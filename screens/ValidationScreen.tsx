      ...
      <SafeAreaView>
          ...
          <View style={styles.logoView}>
            ...
            <View style = {styles.redirectionText}>
                <Text style = {{ color: "#525252", fontSize : 20}}>Votre compte à bien été créé !</Text>
          
           
                <Text style = {{ color: "#525252", fontSize : 14, opacity : 0.6}}>Vous allez être redirigé vers l'écran principal</Text>
            </View>
